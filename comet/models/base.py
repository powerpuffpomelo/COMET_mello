...
class CometModel(ptl.LightningModule, metaclass=abc.ABCMeta):
    ...
    def __init__(
        ...
        self.dataset_already = dataset_already
    ...
    def setup(self, stage) -> None:
        ...
        if stage in (None, "fit"):
            ...
            """
            [{'src': 'That, in fact, is what makes it different from advertising.', 'mt': 'Das macht sie in der Tat anders als Werbung.', 'ref': 'Dies macht den Unterschied der Information zur Werbung aus.', 'score': -0.974609375}, {'src': 'That, in fact, is what makes it different from advertising.', 'mt': 'Das macht sie in der Tat anders als die Werbung.', 'ref': 'Dies macht den Unterschied der Information zur Werbung aus.', 'score': -0.99365234375}]
            """
            ...
            train_subset = np.random.choice(a=len(self.train_dataset), size=10)
